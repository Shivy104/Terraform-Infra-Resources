rg_config = {
  "rg1" = {
    resource_group_name               = "rg-shivam-prod"
...
sqldb1 = {
  name_server        = "mssqlserver420-prod"
  resource_group_name = "rg-shivam-prod"
  name_db = "sqldb420-prod"
